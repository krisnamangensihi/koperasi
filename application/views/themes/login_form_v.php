...
<head>
	<meta charset="UTF-8">
	<title>Login-Koperasi Syari'ah</title>
...
<body>
	...
	<div class="form-box" id="login-box">
		<div class="header"><img height='80' align="center" >SISTEM KOPERASI SYARI'AH</div>
		<form action="" method="post">
			...
			<div class="footer"> 
		<div align="center">&copy; Modified by. SAIFUL HADI <?php echo date('Y'); ?> </div> 
			</div>
		</form>
	</div>
